                 ...
                 <table class="table table-striped " id="dataTable" style="text-align: center;">
                     <thead>
                         <tr>
                             ...
                             <td style="border: 1px solid #9e9a9a; border-radius: 5px;">NAMA PROVINSI</th>
                     ...
                     @foreach ($provinsis as $provinsi)
                         ...
                         <td style="border: 1px solid #9e9a9a; border-radius: 5px;">{{ $provinsi->nama_provinsi }}</td>
                         {{-- <td style="border: 1px solid #9e9a9a; border-radius: 5px;">{{ $provinsi->kode_dagri_provinsi }}</td> --}}
                         ...
                         <td style="border: 1px solid #9e9a9a; border-radius: 5px;">
                          <a href="{{ route('provinsi.kabkot', ['kode_provinsi'=> $provinsi->kode_provinsi]) }}" id="showButton" class="btn btn-sm btn-dark">KAB/KOTA</a>
                          </td>
                         </tr>
                         @endforeach
                     </tbody>

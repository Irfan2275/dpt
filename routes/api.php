...
{
Route::get('/provinsi',[ApiProvinsiController::class, 'index'])->middleware('ability:user_dapil');
Route::get('/provinsi/{nama_provinsi}',[ApiProvinsiController::class, 'show'])->middleware('ability:relawan');
});
